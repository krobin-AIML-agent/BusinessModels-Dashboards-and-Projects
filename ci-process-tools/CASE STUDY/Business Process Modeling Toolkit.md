...
- Standardize analysis across projects → reduce errors and wasted motion.
...
- Lead Time / Queue Time (Little’s Law)
- Overall Equipment Effectiveness (OEE)

## Benefits
- Plug-and-Play: Simply enter process data → get standardized outputs.
...
- Scenario Analysis: Test “what-if” capacity, manpower, or scrap scenarios.
